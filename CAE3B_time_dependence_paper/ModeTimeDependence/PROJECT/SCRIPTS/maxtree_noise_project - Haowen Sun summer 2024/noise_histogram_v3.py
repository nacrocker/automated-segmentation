#this version is a rewrite of root['PROJECT']['SCRIPTS']['maxtree_noise_project - Haowen Sun summer 2024']['noise_histograms_v2_fixes']
#to offer better control of chirps and modes
import numpy as np
